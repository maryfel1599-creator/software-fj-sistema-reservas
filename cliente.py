...
class Cliente(EntidadSistema):
    ...
    def __init__(self, documento, nombre, correo, telefono):
        """
        Inicializa un cliente y valida todos sus datos.
        """
    ...
    def nombre(self, valor):
        ...
        nombre_limpio = " ".join(str(valor).strip().split())
        ...
        # Se comprueba que no contenga números.
        if any(caracter.isdigit() for caracter in nombre_limpio):
            raise NombreInvalidoError(
    ...
    def correo(self, valor):
        ...
        # Se convierte el correo a texto y minúsculas.
        ...
        # Se comprueba que el correo coincida completamente.
        if not re.fullmatch(patron_correo, correo_limpio):
            raise CorreoInvalidoError(
    ...
    def telefono(self, valor):
        ...
        telefono_limpio = str(valor).strip().replace(" ", "")
